...
const learnPeh = {
  ...
  questions: {
    easy: [
      ...
      // Question 8: Review - find previous letter ע
      {
        id: 'lp-e8',
      ...
      // Question 9: Review - find letter ס (two before)
      {
        id: 'lp-e9',
      ...
      // Question 10: Multi-select - mark last 4 letters נ, ס, ע, פ
      {
        id: 'lp-e10',
      ...
      wordLettersQuestionFor('פ', 'lp-e11'),
    ],
  },
};
